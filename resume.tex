...
\begin{resume}
    ...
    Founded multiple small software startups in multiple industries. Businesses
    were SaaS related, mainly catering to technologists. Have sold off most of
    my interests in these to date.
    ...
    \emph{Languages:} Rust, C, C++, Python, Ruby, Bash, Go, Rust, Java, Scala, Kotlin, \LaTeX \\
