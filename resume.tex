...
\begin{itemize}
    ...
    \item Built multiple high-impact open-source projects:
        \begin{itemize}
            \item \href{https://github.com/brndnmtthws/conky/}{\textbf{Conky}} (7.5k+ stars): A cross-platform system monitor with extensive customization.
            ...
            \item \href{https://github.com/brndnmtthws/dryoc/}{\textbf{dryoc}} (300+ stars): A Rust cryptographic library offering memory-safe APIs.
        \end{itemize}
\end{itemize}
...
\filbreak
\textbf{Ellipsis Labs} \hfill \textit{2025 -- present}\\
\textit{Software Engineer, New York, NY}

\begin{itemize}
    \item Building Atlas, a next-generation global computer for financial services.
\end{itemize}
