...
\begin{resume}
    ...
    Have contributed to hundreds of open source projects, am a member of the
    Apache Software Foundation, and have personally created a number of popular
    projects outlined below:

    \href{https://github.com/brndnmtthws/conky}{\textbf{Conky}}, a system monitor utility for X11 systems \hfill \textbf{5600+ GitHub stars}

    \href{https://github.com/brndnmtthws/thetagang}{\textbf{thetagang}}, trading tool for selling equity options \hfill \textbf{1500+ GitHub stars}

    \href{https://github.com/brndnmtthws/dryoc}{\textbf{dryoc}}, pure-Rust cryptography library compatible with libsodium \hfill \textbf{120+ GitHub stars}
